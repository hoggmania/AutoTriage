...
public final class TestArtifactStore implements ArtifactStore {
    ...
    public ArtifactRef putBytes(byte[] bytes, String kind, String mediaType) {
        return put(new ArtifactContent(bytes, kind, mediaType, "test-run", "test"));
    }
    @Override public ArtifactRef put(ArtifactContent content) {
        try {
    ...
    @Override public ArtifactContent get(ArtifactRef ref) {
